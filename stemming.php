...
tokens();
function stemming(){
$myfile1 = fopen("tokens1.txt", "r") or die("Unable to open file!");
$myfile2 = fopen("tokens2.txt", "r") or die("Unable to open file!");
$write1 = fopen("stemming1.txt", "w+") or die("Unable to open file!");
$write2 = fopen("stemming2.txt", "w+") or die("Unable to open file!");
class Stemmer
...
$stemmedWord=$stemm->stem($text1);
//echo $stemmedWord."<br/>";
fwrite($write1,$stemmedWord." ");
	}
	fclose($myfile1);
////source2 below
//$stemm1= new Stemmer;
...
$stemmedWord2=$stemm->stem($text2);
//echo $stemmedWord2."<br/>";
fwrite($write2,$stemmedWord2." ");
	}
